...
import { attachGridDragDrop } from "./gridDragDrop";
...
export function renderInventory(panel: HTMLElement, state: AppState): void {
  ...
  panel.innerHTML = `
    ...
    <p class="panel-desc">Сітка 10×8. Перетягніть предмети мишею, щоб змінити позицію в сітці.</p>
    <div class="stats-row">
  ...
  attachGridDragDrop(gridEl, state, stacks);
